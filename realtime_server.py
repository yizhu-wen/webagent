...
phase-change source columns for live Stage-4 line plotting, plus left/right
micro-Doppler spectrum columns. The deployed app uses server.py's same-origin
/realtime endpoint.
"""
